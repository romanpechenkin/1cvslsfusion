...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Запрос.УстановитьПараметр("ДенежнаяЯчейка", Касса);
	...
	Если СуммаСНДС > ОстатокВДенежнойЯчейке Тогда
		...
		Сообщить("Ошибка при проведении " + Ссылка + ", отрицательный остаток денежных средств в кассе: " + (СуммаСНДС - ОстатокВДенежнойЯчейке));
